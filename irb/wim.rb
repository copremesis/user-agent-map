...
@year_code = ->(code) {
  set = [*'A'..'Y'] + [*'1'..'9']
  #some logic to determine most recent
  ...
  #miminmum of differences
  while(y + set.size <= current_year) do
    candidates << y
    y += set.size
  end

  #not a good algo ... need to be in the past
...
#set = ([*'A'..'Z'] + [*'1'..'9'])
#@year_code[set[rand(set.size)]]
#set.map {|code| @year_code[code]}
#
#
@year_code['A']
